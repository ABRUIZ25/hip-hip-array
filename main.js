...
for (let i = 0; i <= mixedSignNumbers.length -1; i++){
...
for (let i = 0; i <= symmetricalCapitals.length -1; i++){
...
const fibonacciNumbers = [1, 1, 2, 3, 5, 8, 13, "one", 'two'];
...
const studentSlice = students.slice(3,11)
